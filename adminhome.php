...
$insdb ="INSERT INTO project(projectname,projectdescription,teammember,branchid,startdate,enddate,noofdays,projectdocs,projectstatus) VALUES ('$_POST[projectname]','$_POST[description]','$_POST[teammember]','$_POST[branchid]', '$_POST[startdate]','$_POST[enddate]','$_POST[noofdays]','$_POST[projectdocs]','$_POST[projectstatus]')";
mysql_query($insdb,$con);
	
	?>
    <div id="templatemo_content">  
        <div id="templatemo_content_left">
       	<b>  <p class="bi_para">&nbsp;Welcome Mr / Mrs."<?php echo $_SESSION[names]; ?>"</p></b>
      <p>Employee payroll and Task Management System is an online application. In this Admin has to check / add No. of employees in each branch, Employees records, Tasks and time frame, attendance records, salary details, etc.
